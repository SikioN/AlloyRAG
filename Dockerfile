...
RUN mkdir -p /app/data/tiktoken \
    && uv run alloyrag-download-cache --cache-dir /app/data/tiktoken || status=$?; \
...
RUN apt-get update \
    ...
    && rm -rf /var/lib/apt/lists/* \
    && groupadd -g 1000 alloyrag \
    && useradd -u 1000 -g alloyrag -m -d /home/alloyrag -s /usr/sbin/nologin alloyrag \
    && chown -R alloyrag:alloyrag /app /home/alloyrag
...
ENV HOME=/home/alloyrag \
    XDG_CACHE_HOME=/home/alloyrag/.cache \
    PIP_CACHE_DIR=/home/alloyrag/.cache/pip \
    UV_CACHE_DIR=/home/alloyrag/.cache/uv

# Entrypoint starts as root, fixes mount ownership, then drops to alloyrag.
