...
class OllamaServerInfos:
    def __init__(self, name=None, tag=None):
        self._alloyrag_name = name or os.getenv(
            "OLLAMA_EMULATING_MODEL_NAME", DEFAULT_OLLAMA_MODEL_NAME
        )
        self._alloyrag_tag = tag or os.getenv(
            "OLLAMA_EMULATING_MODEL_TAG", DEFAULT_OLLAMA_MODEL_TAG
        )
        self.ALLOYRAG_SIZE = DEFAULT_OLLAMA_MODEL_SIZE
        self.ALLOYRAG_CREATED_AT = DEFAULT_OLLAMA_CREATED_AT
        self.ALLOYRAG_DIGEST = DEFAULT_OLLAMA_DIGEST

    @property
    def ALLOYRAG_NAME(self):
        return self._alloyrag_name

    @ALLOYRAG_NAME.setter
    def ALLOYRAG_NAME(self, value):
        self._alloyrag_name = value

    @property
    def ALLOYRAG_TAG(self):
        return self._alloyrag_tag

    @ALLOYRAG_TAG.setter
    def ALLOYRAG_TAG(self, value):
        self._alloyrag_tag = value

    @property
    def ALLOYRAG_MODEL(self):
        return f"{self._alloyrag_name}:{self._alloyrag_tag}"
...
class BaseVectorStorage(StorageNameSpace, ABC):
    ...
    async def upsert(self, data: dict[str, dict[str, Any]]) -> None:
        ...
        Multi-worker note:
            ...
            alloyrag-gunicorn) other workers will not observe these writes
...
class BaseKVStorage(StorageNameSpace, ABC):
    ...
    async def upsert(self, data: dict[str, dict[str, Any]]) -> None:
        ...
        Multi-worker note:
            ...
            deployment (e.g. alloyrag-gunicorn) other workers will not
