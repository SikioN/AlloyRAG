...
from alloyrag.utils import logger, compute_mdhash_id, validate_workspace
from alloyrag.base import BaseVectorStorage
...
class FaissVectorDBStorage(BaseVectorStorage):
    """Faiss-backed vector storage for AlloyRAG.
