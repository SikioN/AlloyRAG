...
class MilvusVectorDBStorage(BaseVectorStorage):
    ...
    def _create_schema_for_namespace(self) -> CollectionSchema:
        ...
        if self.namespace.endswith("entities"):
            ...
            description = "AlloyRAG entities vector storage"
            ...
            description = "AlloyRAG relationships vector storage"
            ...
            description = "AlloyRAG chunks vector storage"
            ...
            description = "AlloyRAG generic vector storage"
    ...
    def _validate_collection_and_load(self) -> None:
        try:
            ...
            logger.error(
                f"[{self.workspace}] 4. Consider recreating the collection using: alloyrag-rebuild-vdb "
            )
            logger.error(
