...
from alloyrag.constants import DEFAULT_TEMPERATURE
...
# in AlloyRAG. It provides a standardized framework for:
#
...
class BindingOptions:
    ...
    def generate_dot_env_sample(cls):
        """
        Generate a sample .env file for all AlloyRAG binding options.
        ...
        sample_top = (
            ...
            + "\n"
            + (
                "# Autogenerated .env entries list for AlloyRAG binding options\n"
                "#\n"
                "# To generate run:\n"
                "# $ python -m alloyrag.llm.binding_options\n"
            )
            + "#" * 80
            + "\n"
        )
        ...
        sample_bottom = (
            ("#\n# End of .env entries for AlloyRAG binding options\n")
            + "#" * 80
            + "\n"
        )
...
# inferenceConfig that AlloyRAG's bedrock driver actually forwards. See
# ``alloyrag/llm/bedrock.py`` for the whitelist — any field added here that is
...
#
# Usage:
#   python -m alloyrag.llm.binding_options           # Generate .env sample
#   python -m alloyrag.llm.binding_options test      # Test argument parsing
#
# =============================================================================
