"""
Gemini LLM binding for AlloyRAG.

This module provides asynchronous helpers that adapt Google's Gemini models
to the same interface used by the rest of the AlloyRAG LLM bindings. The
...
def _normalize_gemini_response_schema(response_format: Any) -> Any | None:
    """Extract a Gemini-compatible JSON schema from AlloyRAG/OpenAI inputs."""
