...
Two contracts coexist intentionally:
  ...
  - **Legacy contract** — :func:`chunking_by_token_size` keeps its
    ...
    so externally-supplied :attr:`alloyrag.AlloyRAG.chunking_func`
    ...
    :meth:`AlloyRAG.ainsert` calls with raw text.
  ...
  - **File-chunker contract** — for documents whose ``process_options``
    ...
    Currently shipped file chunkers:
      ...
      - :func:`chunking_by_semantic_vector` — the ``"V"`` strategy.
        ...
        :class:`~alloyrag.utils.EmbeddingFunc`.
...
from alloyrag.chunker.paragraph_semantic import chunking_by_paragraph_semantic
from alloyrag.chunker.recursive_character import (
    chunking_by_recursive_character,
)
from alloyrag.chunker.semantic_vector import chunking_by_semantic_vector
from alloyrag.chunker.token_size import (
