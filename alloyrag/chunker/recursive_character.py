...
output rows in the AlloyRAG file-chunker schema. The splitter walks the
...
Token accounting goes through the AlloyRAG :class:`Tokenizer` via the
...
:func:`alloyrag.utils.enforce_chunk_token_limit_before_embedding` does the
...
def chunking_by_recursive_character(
    ...
    *,
    ...
    Args:
        tokenizer: AlloyRAG tokenizer; used as the length function so
