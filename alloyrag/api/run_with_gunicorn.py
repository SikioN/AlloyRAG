#!/usr/bin/env python
"""
Start AlloyRAG server with Gunicorn
"""
...
# Capture this before importing AlloyRAG modules, because those imports load .env.
...
def _build_global_concurrency_limits(args) -> dict:
    ...
    """
    from alloyrag.llm_roles import ROLES
...
def main():
    from alloyrag.api.utils_api import display_splash_screen, check_env_file
    from alloyrag.api.config import global_args, initialize_config
    ...
    os.environ["ALLOYRAG_GUNICORN_MODE"] = "1"
    ...
    if (
        ...
        print("     alloyrag-server --workers 1")
        print("=" * 80 + "\n")
        sys.exit(1)
    ...
    print("🚀 Starting AlloyRAG with Gunicorn")
    ...
    class GunicornApp(BaseApplication):
        ...
        def load(self):
            ...
            from alloyrag.api.alloyrag_server import get_application
    ...
    if workers_count > 1:
        ...
        os.environ["ALLOYRAG_MAIN_PROCESS"] = "1"
