...
from alloyrag.api.utils_api import (
...
from alloyrag.utils import get_env_value
from alloyrag import AlloyRAG, ROLES, RoleLLMConfig, __version__ as core_version
from alloyrag.api import __api_version__
from alloyrag.utils import EmbeddingFunc
from alloyrag.constants import (
    DEFAULT_LOG_MAX_BYTES,
    DEFAULT_LOG_BACKUP_COUNT,
    DEFAULT_LOG_FILENAME,
)
from alloyrag.api.routers.document_routes import (
    DocumentManager,
    create_document_routes,
)
from alloyrag.parser.plugins import load_third_party_parsers
from alloyrag.parser.routing import (
    parser_rules_from_env,
    validate_parser_routing_config,
)
from alloyrag.parser.external.mineru.cache import MinerUParserOptions
...
from alloyrag.api.routers.ollama_api import OllamaAPI

from alloyrag.utils import logger, set_verbose_debug
from alloyrag.kg.shared_storage import (
    get_namespace_data,
...
def _inject_swagger_theme(html: str, theme: str) -> str:
    ...
    # single boolean attribute `data-alloyrag-docs-dark` on <html>. CSS below
          ...
          (function () {{
            ...
            function apply(value) {{
              ...
              if (resolveDark(currentTheme)) {{
                root.setAttribute('data-alloyrag-docs-dark', '1');
              }} else {{
                root.removeAttribute('data-alloyrag-docs-dark');
              }}
            }}
            apply(currentTheme);
            ...
            window.addEventListener('message', function (event) {{
              var data = event.data;
              if (!data || data.type !== 'alloyrag:set-docs-theme') return;
              apply(data.theme);
            }});
          }})();
        </script>
        <style>
          html[data-alloyrag-docs-dark="1"] {{
            color-scheme: dark;
          }}

          html[data-alloyrag-docs-dark="1"] body,
          html[data-alloyrag-docs-dark="1"] .swagger-ui,
          html[data-alloyrag-docs-dark="1"] .swagger-ui .scheme-container,
          html[data-alloyrag-docs-dark="1"] .swagger-ui section.models,
          html[data-alloyrag-docs-dark="1"] .swagger-ui .model-box,
          html[data-alloyrag-docs-dark="1"] .swagger-ui .opblock,
          html[data-alloyrag-docs-dark="1"] .swagger-ui .dialog-ux .modal-ux,
          html[data-alloyrag-docs-dark="1"] .swagger-ui .auth-container {{
            background: #0f172a;
            color: #e5e7eb;
          }}

          html[data-alloyrag-docs-dark="1"] .swagger-ui .info .title,
          html[data-alloyrag-docs-dark="1"] .swagger-ui .opblock-tag,
          html[data-alloyrag-docs-dark="1"] .swagger-ui .opblock .opblock-summary-description,
          html[data-alloyrag-docs-dark="1"] .swagger-ui .model-title,
          html[data-alloyrag-docs-dark="1"] .swagger-ui .parameter__name,
          html[data-alloyrag-docs-dark="1"] .swagger-ui .parameter__type,
          html[data-alloyrag-docs-dark="1"] .swagger-ui .response-col_status,
          html[data-alloyrag-docs-dark="1"] .swagger-ui .response-col_description,
          html[data-alloyrag-docs-dark="1"] .swagger-ui .auth-container h4,
          html[data-alloyrag-docs-dark="1"] .swagger-ui .auth-container label,
          html[data-alloyrag-docs-dark="1"] .swagger-ui .auth-container p,
          html[data-alloyrag-docs-dark="1"] .swagger-ui .markdown p,
          html[data-alloyrag-docs-dark="1"] .swagger-ui .markdown li,
          html[data-alloyrag-docs-dark="1"] .swagger-ui .renderedMarkdown p,
          html[data-alloyrag-docs-dark="1"] .swagger-ui .renderedMarkdown li,
          html[data-alloyrag-docs-dark="1"] .swagger-ui table thead tr th,
          html[data-alloyrag-docs-dark="1"] .swagger-ui table tbody tr td,
          html[data-alloyrag-docs-dark="1"] .swagger-ui .tab li,
          html[data-alloyrag-docs-dark="1"] .swagger-ui .tab li button.tablinks {{
            color: #e5e7eb;
          }}

          html[data-alloyrag-docs-dark="1"] .swagger-ui .opblock-description-wrapper p,
          html[data-alloyrag-docs-dark="1"] .swagger-ui .opblock-external-docs-wrapper p,
          html[data-alloyrag-docs-dark="1"] .swagger-ui .response-col_links {{
            color: #cbd5f5;
          }}

          html[data-alloyrag-docs-dark="1"] .swagger-ui input,
          html[data-alloyrag-docs-dark="1"] .swagger-ui textarea,
          html[data-alloyrag-docs-dark="1"] .swagger-ui select {{
            background: #020617;
            border-color: #334155;
            color: #f8fafc;
          }}

          html[data-alloyrag-docs-dark="1"] .swagger-ui .markdown code,
          html[data-alloyrag-docs-dark="1"] .swagger-ui .renderedMarkdown code,
          html[data-alloyrag-docs-dark="1"] .swagger-ui .highlight-code,
          html[data-alloyrag-docs-dark="1"] .swagger-ui .highlight-code pre,
          html[data-alloyrag-docs-dark="1"] .swagger-ui .microlight,
          html[data-alloyrag-docs-dark="1"] .swagger-ui .body-param__example,
          html[data-alloyrag-docs-dark="1"] .swagger-ui .example,
          html[data-alloyrag-docs-dark="1"] .swagger-ui .model-example pre {{
            background: #020617;
            color: #e2e8f0;
          }}
          ...
          html[data-alloyrag-docs-dark="1"] .swagger-ui .tab li.active button.tablinks,
          html[data-alloyrag-docs-dark="1"] .swagger-ui .tab li.tabitem.active {{
            color: #f8fafc;
            border-bottom-color: #34d399;
          }}

          html[data-alloyrag-docs-dark="1"] .swagger-ui .btn.authorize,
          html[data-alloyrag-docs-dark="1"] .swagger-ui .auth-wrapper .authorize {{
            background: #064e3b;
            border-color: #34d399;
            color: #d1fae5;
          }}

          html[data-alloyrag-docs-dark="1"] .swagger-ui .btn.authorize svg {{
            fill: #d1fae5;
          }}
          ...
          html[data-alloyrag-docs-dark="1"] .swagger-ui section.models,
          html[data-alloyrag-docs-dark="1"] .swagger-ui section.models.is-open,
          html[data-alloyrag-docs-dark="1"] .swagger-ui section.models h4,
          html[data-alloyrag-docs-dark="1"] .swagger-ui section.models .model-container,
          html[data-alloyrag-docs-dark="1"] .swagger-ui section.models .models-control,
          html[data-alloyrag-docs-dark="1"] .swagger-ui .model-box {{
            background: #111827;
            border-color: #334155;
          }}
          ...
          html[data-alloyrag-docs-dark="1"] .swagger-ui section.models h4,
          html[data-alloyrag-docs-dark="1"] .swagger-ui section.models h4 button,
          html[data-alloyrag-docs-dark="1"] .swagger-ui section.models h4 a,
          html[data-alloyrag-docs-dark="1"] .swagger-ui section.models h4 span,
          html[data-alloyrag-docs-dark="1"] .swagger-ui section.models .models-control,
          html[data-alloyrag-docs-dark="1"] .swagger-ui section.models .models-control button,
          html[data-alloyrag-docs-dark="1"] .swagger-ui section.models .model-toggle,
          html[data-alloyrag-docs-dark="1"] .swagger-ui .model,
          html[data-alloyrag-docs-dark="1"] .swagger-ui .model .model-title__text,
          html[data-alloyrag-docs-dark="1"] .swagger-ui .model .property,
          html[data-alloyrag-docs-dark="1"] .swagger-ui .model .prop-name,
          html[data-alloyrag-docs-dark="1"] .swagger-ui .model .prop-type,
          html[data-alloyrag-docs-dark="1"] .swagger-ui .model .prop-format,
          html[data-alloyrag-docs-dark="1"] .swagger-ui .expand-operation,
          html[data-alloyrag-docs-dark="1"] .swagger-ui .expand-operation span {{
            color: #e5e7eb;
          }}

          html[data-alloyrag-docs-dark="1"] .swagger-ui section.models h4 svg,
          html[data-alloyrag-docs-dark="1"] .swagger-ui section.models .models-control svg,
          html[data-alloyrag-docs-dark="1"] .swagger-ui .model-toggle::after,
          html[data-alloyrag-docs-dark="1"] .swagger-ui .expand-operation svg,
          html[data-alloyrag-docs-dark="1"] .swagger-ui .json-schema-2020-12-accordion__icon svg,
          html[data-alloyrag-docs-dark="1"] .swagger-ui .json-schema-2020-12-accordion__icon svg path {{
            fill: #e5e7eb;
          }}
          ...
          html[data-alloyrag-docs-dark="1"] .swagger-ui .json-schema-2020-12,
          html[data-alloyrag-docs-dark="1"] .swagger-ui .json-schema-2020-12__title,
          html[data-alloyrag-docs-dark="1"] .swagger-ui .json-schema-2020-12-property .json-schema-2020-12__title,
          html[data-alloyrag-docs-dark="1"] .swagger-ui .json-schema-2020-12-expand-deep-button,
          html[data-alloyrag-docs-dark="1"] .swagger-ui .json-schema-2020-12-accordion,
          html[data-alloyrag-docs-dark="1"] .swagger-ui .json-schema-2020-12-keyword__name,
          html[data-alloyrag-docs-dark="1"] .swagger-ui .json-schema-2020-12-keyword__name--primary,
          html[data-alloyrag-docs-dark="1"] .swagger-ui .json-schema-2020-12-keyword__value--primary,
          html[data-alloyrag-docs-dark="1"] .swagger-ui .json-schema-2020-12__attribute,
          html[data-alloyrag-docs-dark="1"] .swagger-ui .json-schema-2020-12__attribute--primary,
          html[data-alloyrag-docs-dark="1"] .swagger-ui .json-schema-2020-12-json-viewer__name,
          html[data-alloyrag-docs-dark="1"] .swagger-ui .json-schema-2020-12-json-viewer__name--primary,
          html[data-alloyrag-docs-dark="1"] .swagger-ui .json-schema-2020-12-json-viewer__value--primary,
          html[data-alloyrag-docs-dark="1"] .swagger-ui .json-schema-2020-12-keyword--const .json-schema-2020-12-json-viewer__name,
          html[data-alloyrag-docs-dark="1"] .swagger-ui .json-schema-2020-12-keyword--const .json-schema-2020-12-json-viewer__value,
          html[data-alloyrag-docs-dark="1"] .swagger-ui .json-schema-2020-12-keyword--default .json-schema-2020-12-json-viewer__name,
          html[data-alloyrag-docs-dark="1"] .swagger-ui .json-schema-2020-12-keyword--default .json-schema-2020-12-json-viewer__value,
          html[data-alloyrag-docs-dark="1"] .swagger-ui .json-schema-2020-12-keyword--enum .json-schema-2020-12-json-viewer__name,
          html[data-alloyrag-docs-dark="1"] .swagger-ui .json-schema-2020-12-keyword--enum .json-schema-2020-12-json-viewer__value,
          html[data-alloyrag-docs-dark="1"] .swagger-ui .json-schema-2020-12-keyword--examples .json-schema-2020-12-json-viewer__name,
          html[data-alloyrag-docs-dark="1"] .swagger-ui .json-schema-2020-12-keyword--examples .json-schema-2020-12-json-viewer__value {{
            color: #e5e7eb;
          }}

          /* Secondary / extension / description text — keep them visible but
             dimmer than primary titles. */
          html[data-alloyrag-docs-dark="1"] .swagger-ui .json-schema-2020-12-keyword__name--secondary,
          html[data-alloyrag-docs-dark="1"] .swagger-ui .json-schema-2020-12-keyword__value,
          html[data-alloyrag-docs-dark="1"] .swagger-ui .json-schema-2020-12-keyword__value--secondary,
          html[data-alloyrag-docs-dark="1"] .swagger-ui .json-schema-2020-12-keyword__name--extension,
          html[data-alloyrag-docs-dark="1"] .swagger-ui .json-schema-2020-12-keyword__value--extension,
          html[data-alloyrag-docs-dark="1"] .swagger-ui .json-schema-2020-12-keyword--description,
          html[data-alloyrag-docs-dark="1"] .swagger-ui .json-schema-2020-12-json-viewer__name--secondary,
          html[data-alloyrag-docs-dark="1"] .swagger-ui .json-schema-2020-12-json-viewer__value,
          html[data-alloyrag-docs-dark="1"] .swagger-ui .json-schema-2020-12-json-viewer__value--secondary,
          html[data-alloyrag-docs-dark="1"] .swagger-ui .json-schema-2020-12-json-viewer__name--extension,
          html[data-alloyrag-docs-dark="1"] .swagger-ui .json-schema-2020-12-json-viewer__value--extension,
          html[data-alloyrag-docs-dark="1"] .swagger-ui .json-schema-2020-12-json-viewer-extension-keyword .json-schema-2020-12-json-viewer__name,
          html[data-alloyrag-docs-dark="1"] .swagger-ui .json-schema-2020-12-json-viewer-extension-keyword .json-schema-2020-12-json-viewer__value,
          html[data-alloyrag-docs-dark="1"] .swagger-ui .json-schema-2020-12__attribute--muted {{
            color: #cbd5f5;
          }}
          ...
          html[data-alloyrag-docs-dark="1"] .swagger-ui .json-schema-2020-12-keyword__value--warning,
          html[data-alloyrag-docs-dark="1"] .swagger-ui .json-schema-2020-12-json-viewer__value--warning,
          html[data-alloyrag-docs-dark="1"] .swagger-ui .json-schema-2020-12__attribute--warning {{
            color: #fca5a5;
            border-color: #fca5a5;
          }}
          ...
          /* Per-operation Authorize lock icon. Swagger renders it via
             ...
             states. */
          html[data-alloyrag-docs-dark="1"] .swagger-ui .authorization__btn svg,
          html[data-alloyrag-docs-dark="1"] .swagger-ui .authorization__btn .locked,
          html[data-alloyrag-docs-dark="1"] .swagger-ui .authorization__btn .unlocked {{
            fill: #e5e7eb;
          }}
        </style>
        """
...
# in-app component of `webuiPrefix` injected into window.__ALLOYRAG_CONFIG__
# (which the browser sees as `ALLOYRAG_API_PREFIX + WEBUI_PATH + "/"`).
# Not user-configurable: a single mount path simplifies the operator surface
# and matches how AlloyRAG is deployed in practice. See
...
class _RootPathNormalizationMiddleware:
    ...
    When ``ALLOYRAG_API_PREFIX=/site01`` and nginx strips ``/site01`` before
...
class LLMConfigCache:
    ...
    def __init__(self, args):
        ...
        if args.llm_binding in ["openai", "azure_openai"]:
            from alloyrag.llm.binding_options import OpenAILLMOptions
        ...
        if args.llm_binding == "gemini":
            from alloyrag.llm.binding_options import GeminiLLMOptions
        ...
        if args.llm_binding == "bedrock":
            from alloyrag.llm.binding_options import BedrockLLMOptions
        ...
        if args.llm_binding == "ollama":
            try:
                from alloyrag.llm.binding_options import OllamaLLMOptions
        ...
        if args.embedding_binding == "ollama":
            try:
                from alloyrag.llm.binding_options import OllamaEmbeddingOptions
        ...
        if args.embedding_binding == "gemini":
            try:
                from alloyrag.llm.binding_options import GeminiEmbeddingOptions
...
def create_optimized_embedding_function(
    ...
    try:
        if binding == "openai":
            ...
            from alloyrag.llm.gemini import gemini_embed

            provider_func = gemini_embed
        elif binding == "jina":
            from alloyrag.llm.jina import jina_embed

            provider_func = jina_embed
        elif binding == "azure_openai":
            from alloyrag.llm.azure_openai import azure_openai_embed

            provider_func = azure_openai_embed
        elif binding == "bedrock":
            from alloyrag.llm.bedrock import bedrock_embed

            provider_func = bedrock_embed
        elif binding == "lollms":
            from alloyrag.llm.lollms import lollms_embed

            provider_func = lollms_embed
        elif binding == "voyageai":
            from alloyrag.llm.voyageai import voyageai_embed
...
def create_embedding_function_from_args(
    ...
    """Build the fully configured EmbeddingFunc used by the AlloyRAG server.

    Combines the provider embedding factory with the send_dimensions policy
    so that offline tools (e.g. alloyrag-rebuild-vdb) can embed in exactly
...
def check_frontend_build():
    ...
    if not index_html.exists():
        ...
        ASCIIColors.cyan("    cd alloyrag_webui")
    ...
    try:
        source_dir = Path(__file__).parent.parent.parent / "alloyrag_webui"
        ...
        # Key configuration files (in alloyrag_webui root directory)
        key_files = [
...
def create_app(args):
    ...
    # Discover third-party parser engines (``alloyrag.parsers`` entry points)
    # BEFORE validating routing rules, so ALLOYRAG_PARSER may reference them.
    ...
    api_key = os.getenv("ALLOYRAG_API_KEY") or args.key
    ...
    async def lifespan(app: FastAPI):
        ...
        try:
            ...
            if "ALLOYRAG_GUNICORN_MODE" not in os.environ:
    ...
    base_description = (
        "Providing API for AlloyRAG core, Web UI and Ollama Model Emulation"
    )
    swagger_description = (
        base_description
    ...
    # with "Access-Control-Allow-Credentials: true". AlloyRAG authenticates via
    ...
    def get_workspace_from_request(request: Request) -> str | None:
        ...
        'ALLOYRAG-WORKSPACE' header. If not present, falls back to the
        ...
        workspace = request.headers.get("ALLOYRAG-WORKSPACE", "").strip()
    ...
    def create_optimized_openai_llm_func(
        ...
        async def optimized_openai_alike_model_complete(
            ...
            **kwargs,
            ...
            from alloyrag.llm.openai import openai_complete_if_cache
    ...
    def create_optimized_azure_openai_llm_func(
        ...
        async def optimized_azure_openai_model_complete(
            ...
            **kwargs,
            ...
            from alloyrag.llm.azure_openai import azure_openai_complete_if_cache
    ...
    def create_optimized_gemini_llm_func(
        ...
        async def optimized_gemini_model_complete(
            ...
            **kwargs,
            ...
            from alloyrag.llm.gemini import gemini_complete_if_cache
    ...
    def create_llm_model_func(binding: str):
        ...
        try:
            if binding == "lollms":
                from alloyrag.llm.lollms import lollms_model_complete
    ...
    def create_role_llm_func(role: str, override_meta: dict | None = None):
        ...
        try:
            if role_binding == "ollama":
                from alloyrag.llm.ollama import _ollama_model_if_cache
            ...
            if role_binding == "lollms":
                from alloyrag.llm.lollms import lollms_model_if_cache
            ...
            if role_binding == "bedrock":
                from alloyrag.llm.bedrock import bedrock_complete_if_cache
    ...
    if args.rerank_binding != "null":
        from alloyrag.rerank import cohere_rerank, jina_rerank, ali_rerank
    ...
    from alloyrag.api.config import OllamaServerInfos

    ollama_server_infos = OllamaServerInfos(
        name=args.simulated_model_name, tag=args.simulated_model_tag
    )

    # AlloyRAG.__post_init__ normalizes addon_params and backfills env-based defaults
    ...
    try:
        ...
        logger.error(f"Failed to initialize AlloyRAG: {e}")
        raise
            ...
            status_data.update(
                {
                    ...
                    if os.environ.get("ALLOYRAG_GUNICORN_MODE")
                    else "uvicorn",
    ...
    class SmartStaticFiles(StaticFiles):  # Renamed from NoCacheStaticFiles
        ...
        # alloyrag_webui/index.html.
        RUNTIME_CONFIG_PLACEHOLDER = b"<!-- __ALLOYRAG_RUNTIME_CONFIG__ -->"
...
def configure_logging():
    ...
    for logger_name in ["uvicorn", "uvicorn.access", "uvicorn.error", "alloyrag"]:
    ...
    print(f"\nAlloyRAG log file: {log_file_path}\n")
    ...
    logging.config.dictConfig(
        {
            ...
            "filters": {
                "path_filter": {
                    "()": "alloyrag.utils.AlloyRAGPathFilter",
                },
            },
        }
    )
