"""AlloyRAG native DOCX parser package.
...
:meth:`alloyrag.pipeline._PipelineMixin.parse_native` so the native and
MinerU engines share one shape; see :mod:`alloyrag.parser.docx.ir_builder`
