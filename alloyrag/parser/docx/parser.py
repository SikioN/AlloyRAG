...
from alloyrag.constants import PARSER_ENGINE_NATIVE
...
class NativeDocxParser(NativeParserBase):
    """Native DOCX parser for AlloyRAG's production parsing path.
    ...
    def extract(
        ...
        from alloyrag.parser.docx.drawing_image_extractor import (
            DrawingExtractionContext,
            load_relationships,
        )
        from alloyrag.parser.docx.parse_document import extract_docx_blocks
    ...
    def build_ir(
        ...
        *,
        ...
        from alloyrag.parser.docx.ir_builder import NativeDocxIRBuilder
