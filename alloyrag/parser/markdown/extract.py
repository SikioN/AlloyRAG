...
- :class:`alloyrag.parser.markdown.ir_builder.NativeMarkdownIRBuilder` later
...
from alloyrag.parser._html_table import starts_with_html_tag
from alloyrag.parser._markdown import render_heading_line
