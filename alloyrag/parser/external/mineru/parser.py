...
from alloyrag.constants import MINERU_RAW_DIR_SUFFIX, PARSER_ENGINE_MINERU
...
class MinerUParser(ExternalParserBase):
    ...
    force_reparse_env = "ALLOYRAG_FORCE_REPARSE_MINERU"
    ...
    def is_bundle_valid(
        ...
        *,
        ...
        from alloyrag.parser.external.mineru import is_bundle_valid
    ...
    async def download_into(
        ...
        *,
        ...
        from alloyrag.parser.external.mineru import MinerURawClient
    ...
    def build_ir(self, raw_dir: Path, document_name: str) -> "IRDoc":
        from alloyrag.parser.external.mineru import MinerUIRBuilder
