...
This module is the *single executable specification* of the AlloyRAG sidecar
format (``docs/AlloyRAGSidecarFormat-zh.md``). Engine adapters hand it an
...
from alloyrag.sidecar.placeholders import (
    render_drawing_tag,
    render_equation_tag,
    render_table_tag,
    render_template,
...
from alloyrag.table_markup import header_grid_to_thead_html
from alloyrag.utils import logger, strip_control_characters
