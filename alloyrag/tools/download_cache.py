...
def download_tiktoken_cache(cache_dir: str = None, models: list = None):
    ...
    # Common models used by AlloyRAG and OpenAI
    if models is None:
        models = [
            "gpt-4o-mini",  # Default model for AlloyRAG
            "gpt-4o",  # GPT-4 Omni
            "gpt-4",  # GPT-4
            ...
            "cl100k_base",  # Default encoding for AlloyRAG
        ]
...
def main():
    ...
    parser = argparse.ArgumentParser(
        prog="alloyrag-download-cache",
        description="Download cache files for AlloyRAG offline deployment",
...
For more information, visit: https://github.com/SikioN/AlloyRAG
    ...
    parser.add_argument(
        "--version", action="version", version="%(prog)s (AlloyRAG cache downloader)"
    )

    args = parser.parse_args()

    print("=" * 70)
    print("AlloyRAG Offline Cache Downloader")
    print("=" * 70)
