#!/usr/bin/env python3
"""
LLM Cache Migration Tool for AlloyRAG
...
Usage:
    python -m alloyrag.tools.migrate_llm_cache
    # or
    python alloyrag/tools/migrate_llm_cache.py
...
class MigrationTool:
    ...
    def print_header(self):
        """Print tool header"""
        print("\n" + "=" * 50)
        print("LLM Cache Migration Tool - AlloyRAG")
        print("=" * 50)
