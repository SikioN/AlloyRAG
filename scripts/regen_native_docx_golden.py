...
and capture the exact on-disk artifacts ``AlloyRAG.parse_native`` produces
...
async def _regen() -> None:
    ...
    from alloyrag.parser.debug import (
        FrozenDateTime,
        build_debug_rag,
    )
    ...
    for scenario in SCENARIOS:
        ...
        with tempfile.TemporaryDirectory(prefix="regen_") as tmp_root:
            ...
            with (
                ...
                mock.patch("alloyrag.sidecar.writer.datetime", FrozenDateTime),
            ):
