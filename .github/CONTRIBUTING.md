...
- **Bug reports** — open an [issue](https://github.com/HKUDS/AlloyRAG/issues) using the Bug Report template
- **Feature requests** — open an [issue](https://github.com/HKUDS/AlloyRAG/issues) using the Feature Request template
...
Set `ALLOYRAG_RUN_INTEGRATION=true` as an environment variable as an alternative to `--run-integration`.
...
Please use the [Bug Report issue template](https://github.com/HKUDS/AlloyRAG/issues/new?template=bug_report.yml). Include:

- AlloyRAG version and Python version
...
Please use the [Feature Request issue template](https://github.com/HKUDS/AlloyRAG/issues/new?template=feature_request.yml). Describe:
...
For usage questions, check the [Discussions](https://github.com/HKUDS/AlloyRAG/discussions) tab or open a [Question issue](https://github.com/HKUDS/AlloyRAG/issues/new?template=question.yml).
