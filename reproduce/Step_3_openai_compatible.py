...
from alloyrag.utils import EmbeddingFunc, always_get_an_event_loop
import numpy as np


## For Upstage API
# please check if embedding_dim=4096 in alloyrag.py and llm.py in alloyrag direcotry
...
if __name__ == "__main__":
    ...
    rag = AlloyRAG(working_dir=WORKING_DIR)
    rag = AlloyRAG(
