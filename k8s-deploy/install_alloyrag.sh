...
echo "Deploying production AlloyRAG (using external databases)..."
...
helm upgrade --install alloyrag $SCRIPT_DIR/alloyrag \
  --namespace $NAMESPACE \
...
echo ""
echo "Waiting for alloyrag pod to be ready..."
kubectl wait --for=condition=ready pod -l app.kubernetes.io/instance=alloyrag --timeout=300s -n rag
echo "alloyrag pod is ready"
echo ""
echo "Running Port-Forward:"
echo "    kubectl --namespace rag port-forward svc/alloyrag 9621:9621"
echo "==========================================="
echo ""
