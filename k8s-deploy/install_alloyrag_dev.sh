...
helm upgrade --install alloyrag-dev $SCRIPT_DIR/alloyrag \
  --namespace rag \
...
# Wait for AlloyRAG pod to be ready
echo ""
echo "Waiting for alloyrag-dev pod to be ready..."
kubectl wait --for=condition=ready pod -l app.kubernetes.io/instance=alloyrag-dev --timeout=300s -n rag
echo "alloyrag-dev pod is ready"
echo ""
echo "Running Port-Forward:"
echo "    kubectl --namespace rag port-forward svc/alloyrag-dev 9621:9621"
echo "==========================================="
echo ""
echo "✅ You can visit AlloyRAG at: http://localhost:9621"
echo ""
