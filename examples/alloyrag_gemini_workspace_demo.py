"""
AlloyRAG Data Isolation Demo: Workspace Management

This example demonstrates how to maintain multiple isolated knowledge bases
within a single application using AlloyRAG's 'workspace' feature.
...
Usage:
    python alloyrag_workspace_demo.py
"""
...
async def initialize_rag(
    ...
    """
    Initializes a AlloyRAG instance with data isolation.

    Entity type guidance can be customized by passing
    addon_params={'entity_types_guidance': '...'} to AlloyRAG.
    """
...
async def main():
    ...
    try:
        ...
        print("Initializing isolated AlloyRAG workspaces...")
