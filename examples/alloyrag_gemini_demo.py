"""
AlloyRAG Demo with Google Gemini Models

This example demonstrates how to use AlloyRAG with Google's Gemini 2.0 Flash model
...
Usage:
    python examples/alloyrag_gemini_demo.py
"""
