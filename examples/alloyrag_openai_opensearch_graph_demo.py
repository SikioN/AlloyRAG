"""
AlloyRAG Demo with OpenSearch + OpenAI
...
2. Required indices will be auto-created by AlloyRAG
...
from alloyrag.utils import setup_logger, EmbeddingFunc
...
async def main():
    rag = None
    try:
        print("Initializing AlloyRAG with OpenSearch + OpenAI...")
