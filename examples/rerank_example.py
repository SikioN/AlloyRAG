"""
AlloyRAG Rerank Integration Example

This example demonstrates how to use rerank functionality with AlloyRAG
...
from alloyrag.utils import EmbeddingFunc, setup_logger

from functools import partial
from alloyrag.rerank import cohere_rerank
...
async def create_rag_with_rerank():
    """Create AlloyRAG instance with rerank configuration"""
...
async def test_rerank_with_different_settings():
    ...
    """
    print("\n\n🚀 Setting up AlloyRAG with Rerank functionality...")
    ...
    sample_docs = [
        ...
        "AlloyRAG is a powerful retrieval-augmented generation system with multiple query modes.",
...
async def test_direct_rerank():
    ...
    documents = [
        ...
        "AlloyRAG supports advanced reranking capabilities",
...
async def main():
    ...
    print("🎯 AlloyRAG Rerank Integration Example")
    print("=" * 60)
    ...
    try:
        ...
        print("   ✓ Rerank function is configured at AlloyRAG initialization")
