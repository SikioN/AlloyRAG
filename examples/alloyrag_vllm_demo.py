"""
AlloyRAG Demo with vLLM (LLM, Embeddings, and Reranker)
...
Usage:
    python examples/alloyrag_vllm_demo.py
"""
...
from alloyrag.rerank import jina_rerank
