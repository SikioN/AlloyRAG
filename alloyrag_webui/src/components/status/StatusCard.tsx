...
type RoleLLMRow = {
  role: string
  config: AlloyRAGRoleLLMConfig
  queue?: AlloyRAGQueueStatus
}
...
type MinerUStatus = NonNullable<AlloyRAGStatus['configuration']['mineru']>
type DoclingStatus = NonNullable<AlloyRAGStatus['configuration']['docling']>
...
const getModelRows = (status: AlloyRAGStatus): RoleLLMRow[] => {
...
const StatusCard = ({ status }: { status: AlloyRAGStatus | null }) => {
