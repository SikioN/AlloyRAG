...
interface ImportMetaEnv {
   ...
   * into `index.html` as `window.__ALLOYRAG_CONFIG__`, mirroring what the
   ...
   *
   * See `alloyrag_webui/env.development.smaple` and
   ...
   *  `ALLOYRAG_API_PREFIX` if a real prefixed backend is being proxied to. */
