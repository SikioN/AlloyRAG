...
# AlloyRAG aquery_data endpoint test script
# Use curl command to test the new /query/data endpoint and validate the new data format

echo "🚀 AlloyRAG aquery_data Endpoint Test (New Data Format Validation)"
echo "=================================================="
...
echo "1. Ensure AlloyRAG API service is running (python -m alloyrag.api.alloyrag_server)"
