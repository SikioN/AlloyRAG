...
sys.argv = [sys.argv[0]]
_dr = importlib.import_module("alloyrag.api.routers.document_routes")
...
from alloyrag.constants import (  # noqa: E402
    PROCESS_OPTION_CHUNK_FIXED,
    PROCESS_OPTION_CHUNK_PARAGRAH,
    PROCESS_OPTION_CHUNK_RECURSIVE,
    PROCESS_OPTION_CHUNK_VECTOR,
)
from alloyrag.parser.routing import default_chunker_config  # noqa: E402
