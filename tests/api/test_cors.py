"""
Tests for CORS middleware configuration on the AlloyRAG API server.

AlloyRAG authenticates exclusively via request headers (Authorization Bearer
...
# import time of alloyrag.api.config). Tests must be hermetic and not depend on
...
def _isolate_env(monkeypatch):
    ...
    alloyrag.api.config is reset before and after each test so neither developer
