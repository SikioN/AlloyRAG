"""
AlloyRAG Ollama Compatibility Interface Test Script

This script tests the AlloyRAG's Ollama compatibility interface, including:
...
def create_error_test_data(error_type: str) -> Dict[str, Any]:
    ...
    """
    error_data = {
        "empty_messages": {"model": "alloyrag:latest", "messages": [], "stream": True},
        "invalid_role": {
            "model": "alloyrag:latest",
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description="AlloyRAG Ollama Compatibility Interface Testing",
...
Configuration file (config.json):
  {
    "server": {
      ...
      "model": "alloyrag:latest" # Default model name
    },
    "test_cases": {
      "basic": {
