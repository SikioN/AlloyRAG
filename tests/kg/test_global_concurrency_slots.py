...
stats aggregation primitives in alloyrag.kg.shared_storage.
...
from alloyrag.kg import shared_storage as ss
...
def test_first_init_sets_limits_and_later_calls_do_not_overwrite():
    ...
    # Subsequent no-arg call (e.g. AlloyRAG.__post_init__) hits the
