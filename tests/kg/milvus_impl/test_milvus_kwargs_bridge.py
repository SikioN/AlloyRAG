...
from alloyrag.kg.milvus_impl import MilvusVectorDBStorage
...
class TestMilvusKwargsParameterBridge:
    ...
    def test_raganything_framework_integration_scenario(self):
        ...
        sits on top of AlloyRAG and needs to pass Milvus index configuration
        through to AlloyRAG without modifying environment variables.
        ...
        # Simulate RAGAnything framework passing configuration to AlloyRAG
