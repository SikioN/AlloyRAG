...
These tests run the production code path (``AlloyRAG.parse_native``) on
...
from alloyrag.parser.base import ParseContext  # noqa: E402
from alloyrag.parser.debug import (  # noqa: E402
    FrozenDateTime,
    build_debug_rag,
)
from alloyrag.parser.registry import get_parser  # noqa: E402
...
def _run_new_path(
    ...
    """Invoke ``AlloyRAG.parse_native`` on a single scenario.
