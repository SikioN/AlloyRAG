"""Unit tests for the parser registry (alloyrag.parser.registry)."""
...
def test_capability_queries_do_not_import_parser_impls():
    ...
    code = (
        "import sys; import alloyrag.parser.registry as r; "
        ...
        "assert 'alloyrag.parser.external.mineru.parser' not in sys.modules; "
        "print('clean')"
    )
