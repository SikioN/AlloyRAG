"""Tests for ``alloyrag/parser/external/docling/cache.py``.
...
from alloyrag.parser.external import Manifest, ManifestFile, write_manifest
from alloyrag.parser.external._common import compute_size_and_hash
