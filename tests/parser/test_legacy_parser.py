"""Unit tests for the legacy engine adapter (alloyrag.parser.legacy.parser).
...
import alloyrag.pipeline as _pipeline
from alloyrag.constants import FULL_DOCS_FORMAT_RAW
from alloyrag.parser.base import ParseContext
from alloyrag.parser.legacy.extractors import LegacyExtractionError
from alloyrag.parser.legacy.parser import LegacyParser
...
async def test_legacy_parse_whitespace_only_extraction_raises(
    ...
    monkeypatch.setattr(
        "alloyrag.parser.legacy.extractors.extract_text",
...
async def test_legacy_parse_passes_pdf_password_from_env(
    ...
    monkeypatch.setattr("alloyrag.parser.legacy.extractors.extract_text", _capture)
