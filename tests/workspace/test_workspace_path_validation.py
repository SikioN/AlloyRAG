"""Unit tests for ``alloyrag.utils.validate_workspace``.
...
from alloyrag.utils import validate_workspace
...
def _import_document_manager():
    ...
    Importing ``alloyrag.api`` modules triggers the server's argparse against
    ...
    try:
        ...
        from alloyrag.api.routers.document_routes import DocumentManager
