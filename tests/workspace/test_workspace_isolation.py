...
Comprehensive test suite covering workspace isolation in AlloyRAG:
...
11. AlloyRAG End-to-End Workspace Isolation - Complete E2E test with two instances
...
# - Or environment variables: ALLOYRAG_KEEP_ARTIFACTS, ALLOYRAG_STRESS_TEST, ALLOYRAG_TEST_WORKERS
...
# =============================================================================
# Test 11: AlloyRAG End-to-End Integration Test
# =============================================================================


@pytest.mark.offline
async def test_alloyrag_end_to_end_workspace_isolation(keep_test_artifacts):
    """
    End-to-end test: Create two AlloyRAG instances with different workspaces,
    insert different data, and verify file separation.
    Uses mock LLM and embedding functions to avoid external API calls.
    """
    # Purpose: Validate that full AlloyRAG flows keep artifacts scoped per workspace.
    # Scope: AlloyRAG.initialize_storages + ainsert side effects plus filesystem
    # verification for generated storage files.
    print("\n" + "=" * 60)
    print("TEST 11: AlloyRAG End-to-End Workspace Isolation")
    print("=" * 60)

    # Create temporary test directory under project temp/
    test_dir = str(
        Path(__file__).parent.parent.parent
        / "temp/test_alloyrag_end_to_end_workspace_isolation"
    )
    if os.path.exists(test_dir):
        shutil.rmtree(test_dir)
    os.makedirs(test_dir, exist_ok=True)
...
<|COMPLETE|>"""
        ...
        # Test 11.1: Create two AlloyRAG instances with different workspaces
        print("\nTest 11.1: Create two AlloyRAG instances with different workspaces")

        from alloyrag import AlloyRAG
        from alloyrag.utils import EmbeddingFunc, Tokenizer
        ...
        print("✅ PASSED: AlloyRAG E2E - File Structure")
        ...
        if docs_a_file.exists() and docs_b_file.exists():
            ...
            print("✅ PASSED: AlloyRAG E2E - Data Isolation")
