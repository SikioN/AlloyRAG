"""Spec-compliance tests for :func:`alloyrag.sidecar.write_sidecar`.

These assertions are deliberately structural: they encode the contract in
``docs/AlloyRAGSidecarFormat-zh.md`` so accidental regressions in
...
from alloyrag.sidecar import writer as _writer
from alloyrag.sidecar.writer import (
