...
from alloyrag.chunker import chunking_by_semantic_vector  # noqa: E402
from alloyrag.utils import EmbeddingFunc, Tokenizer, TokenizerInterface  # noqa: E402
...
def test_v_chunker_falls_back_to_recursive_when_no_embedding():
    ...
    alloyrag_logger.addHandler(handler)
    try:
        ...
        alloyrag_logger.removeHandler(handler)
...
def test_semantic_groups_mirror_matches_upstream_split_text():
    ...
    from alloyrag.chunker.semantic_vector import _semantic_groups_with_spans
