...
from alloyrag.utils_pipeline import doc_status_parse_failure_fields
...
async def test_parse_worker_logs_when_failed_upsert_itself_fails(
    ...
    try:
        ...
        # alloyrag logger has propagate=False; enable it so caplog captures.
        alloyrag_logger = logging.getLogger("alloyrag")
        monkeypatch.setattr(alloyrag_logger, "propagate", True)
        with caplog.at_level(logging.ERROR, logger="alloyrag"):
            await rag.apipeline_process_enqueue_documents()
