...
from alloyrag.utils_pipeline import strip_alloyrag_doc_prefix
...
async def _build_rag(tmp_path) -> AlloyRAG:
    rag = AlloyRAG(
...
def test_legacy_parse_worker_sanitizes_doc_status_and_full_docs(tmp_path, monkeypatch):
    ...
    async def _run():
        ...
        try:
            ...
            body = strip_alloyrag_doc_prefix(full["content"], full.get("parse_format"))
            assert body == clean
